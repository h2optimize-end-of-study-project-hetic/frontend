...
const ChangeViewRoom = ({ roomId }: ChangeViewProps) => {
  ...
  return (
    ...
    >
      ...
      >
        <Button
          onClick={() =>
            navigate(roomId ? `/room/${roomId}/edit` : "/room/edit")
          }
          variant="contained"
          sx={getButtonStyle("/room/edit")}
        >
          Vue détaillée
        </Button>
        ...
        <Button
          ...
          variant="contained"
          sx={getButtonStyle("/room")}
        >
          Vue tableau
        </Button>

        <Button
          onClick={() => navigate("/room/statistique")}
          variant="contained"
          sx={getButtonStyle("/room/statistique")}
        >
          Statistiques
        </Button>
      </Box>
